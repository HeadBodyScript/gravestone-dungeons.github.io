...
└─  witch
     ...
     └─ reward
# Arcanes
├─  fir = fire resistance? node_of_fire_resistance
├─  hbo = health_boost node_of_health_boost
├─  mag = magica = node_of_mana
├─  nig = night_vision? node_of_night_vision
├─  reg = regeneration node_of_regeneration
├─  res = resistance node_of_resistance
├─  spe = movement_speed? node_of_movement_speed
├─  str = strenght? node_of_strenth
└─  wat = water_breathing? node_of_water_breathing
# Armor_sets
├─  amethyst
├─  armadlillo
├─  axolotl
