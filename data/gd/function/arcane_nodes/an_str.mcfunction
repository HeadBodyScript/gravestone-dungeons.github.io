...
execute as @e[scores={an=50, randomnumber_1=..9}] at @e[type=minecraft:armor_stand,tag=an_str] run title @p[distance=..6] actionbar [{"text":"You walk under the sign of strength.","color":"dark_purple"}]
execute as @e[scores={an=50, randomnumber_1=..9}] at @p run particle minecraft:witch ~ ~1 ~ 0.5 1 0.5 0.05 20 force
execute as @e[scores={an=50, randomnumber_1=..9}] at @e[type=minecraft:armor_stand,tag=an_str] run effect give @p[distance=..6] minecraft:strength 1200 1 true

execute as @e[scores={an=50, randomnumber_1=10}] at @e[type=minecraft:armor_stand,tag=an_str] run title @p[distance=..6] actionbar [{"text":"The wrath of the gods be upon thee, for thy actions displease them.","color":"gray"}]
execute as @e[scores={an=50, randomnumber_1=10}] at @e[type=minecraft:armor_stand,tag=an_str] run effect clear @p[distance=..6] minecraft:strength
execute as @e[scores={an=50, randomnumber_1=10}] at @e[type=minecraft:armor_stand,tag=an_str] run effect give @p[distance=..6] minecraft:mining_fatigue 300 1 true
