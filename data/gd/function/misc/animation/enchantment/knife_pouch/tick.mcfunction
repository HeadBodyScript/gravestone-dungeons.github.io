...
execute as @e[distance=..2] unless score @s enchantment.knife_pouch_LINK = @e[type=minecraft:armor_stand,limit=1,distance=..2.1] enchantment.knife_pouch_LINK run function gd:enchantment/knife_pouch/hit with storage minecraft:damage
