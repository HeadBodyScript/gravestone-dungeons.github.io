...
execute unless items entity @p armor.feet gd:stat_item_item[minecraft:custom_data={stats:1b,lore:1b}] run item modify entity @s armor.feet gd:tools/magma_walker
