...
execute as @s[scores={enchantment.poisoning_VFX=6..7}] run function gd:enchantment/poisoning/other/init
execute as @s[scores={enchantment.poisoning_VFX=15..16}] run function gd:enchantment/poisoning/other/init
