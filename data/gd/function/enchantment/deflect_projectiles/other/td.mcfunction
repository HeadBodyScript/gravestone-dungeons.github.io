...
execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:arrow,distance=..4]
execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:spectral_arrow,distance=..4]
execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:fireball,distance=..4]
execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:dragon_fireball,distance=..4]
execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:snowball,distance=..4]
execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:firework_rocket,distance=..4]
execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:potion,distance=..4]
execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:wither_skull,distance=..4]
