...
execute if score @p check matches 20 run particle minecraft:soul_fire_flame ~ ~1.2 ~ .2 .1 .2 .05 1 force
execute if score @p check matches 0 run particle minecraft:soul_fire_flame ~ ~1.2 ~ .2 .1 .2 .05 1 force
execute if score @p check matches 10 run particle minecraft:soul ~ ~1.2 ~ 0.4 0 0.4 0.001 1 force
