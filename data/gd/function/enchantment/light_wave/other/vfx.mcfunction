...
execute as @s[scores={enchantment.light_wave_TD=96..}] at @s run function gd:enchantment/light_wave/other/init
execute as @s[scores={enchantment.light_wave_TD=66..}] at @s run function gd:enchantment/light_wave/other/init
execute as @s[scores={enchantment.light_wave_TD=36..}] at @s run function gd:enchantment/light_wave/other/init
execute as @s[scores={enchantment.light_wave_TD=6..}] at @s run function gd:enchantment/light_wave/other/init
execute as @s[scores={enchantment.light_wave_TD=36..}] at @s run function gd:enchantment/light_wave/other/init
execute as @s[scores={enchantment.light_wave_TD=66..}] at @s run function gd:enchantment/light_wave/other/init
execute as @s[scores={enchantment.light_wave_TD=96..}] at @s run function gd:enchantment/light_wave/other/init

execute at @s as @e[distance=..1] unless score @s enchantment.light_wave_VFX matches 0.. run function gd:enchantment/light_wave/other/hit
