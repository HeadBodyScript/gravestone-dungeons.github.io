...
execute unless items entity @p armor.feet gd:stat_item_item[minecraft:custom_data={stats:1b,lore:1b}] unless items entity @p armor.chest gd:stat_item_item[minecraft:custom_data={stats:1b,lore:1b}] run item modify entity @s armor.feet gd:tools/veil_of_shadows
