...
execute as @s[scores={enchantment.void_sphere_TD=100..}] run function gd:enchantment/void_sphere/other/init
...
execute as @s[scores={enchantment.void_sphere_TD=150..}] run damage @e[type=#gd:normal_mobs,tag=!companion,tag=!boss,distance=..2.5,limit=1,sort=nearest] 10 minecraft:cramming
...
execute if entity @s[scores={enchantment.void_sphere_TD=150..}] at @e[type=#gd:mobs,tag=void_me,limit=1,sort=nearest] at @s run function gd:enchantment/void_sphere/other/projectile
