...
execute as @e[type=#gd:mobs,tag=evoker_fangs] at @s run function gd:enchantment/evoker_fangs/hit
...
execute if score @s enchantment_evoker_fangs matches 25 run tag @e[type=#gd:mobs,distance=..10,limit=4,sort=random] add evoker_fangs
execute if score @s enchantment_evoker_fangs matches 50 run particle minecraft:witch ~ ~1 ~ 0.1 0.5 0.1 0.7 10
execute if score @s enchantment_evoker_fangs matches 50 run tag @e[type=#gd:mobs,distance=..10,limit=4,sort=random] add evoker_fangs
execute if score @s enchantment_evoker_fangs matches 75 run particle minecraft:witch ~ ~1 ~ 0.1 0.5 0.1 0.7 10
execute if score @s enchantment_evoker_fangs matches 75 run tag @e[type=#gd:mobs,distance=..10,limit=4,sort=random] add evoker_fangs
execute if score @s enchantment_evoker_fangs matches 100 run particle minecraft:witch ~ ~1 ~ 0.1 0.5 0.1 0.7 10
execute if score @s enchantment_evoker_fangs matches 100 run tag @e[type=#gd:mobs,distance=..10,limit=4,sort=random] add evoker_fangs
