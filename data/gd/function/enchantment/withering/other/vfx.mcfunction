...
execute as @s[scores={enchantment.withering_VFX=6..10}] as @e[type=armor_stand,tag=marker_withering_animation] at @s run tp @s ^ ^.7 ^ ~ ~
...
execute as @s[scores={enchantment.withering_VFX=2}] run playsound minecraft:entity.warden.agitated master @s ~ ~ ~ 20 .8
execute as @s[scores={enchantment.withering_VFX=2}] run playsound minecraft:entity.player.attack.knockback master @s ~ ~ ~ 20 .5
execute as @s[scores={enchantment.withering_VFX=8}] run playsound minecraft:entity.warden.sonic_charge master @s ~ ~ ~ 20 .5
execute as @s[scores={enchantment.withering_VFX=12}] run playsound minecraft:entity.player.attack.sweep master @s ~ ~ ~ 20 1
execute as @s[scores={enchantment.withering_VFX=12}] run playsound minecraft:entity.warden.sonic_charge master @s ~ ~ ~ 20 .5
execute as @s[scores={enchantment.withering_VFX=19}] run playsound minecraft:entity.warden.agitated master @s ~ ~ ~ 20 2
...
# execute at @e[scores={enchantment.withering_VFX=80},type=armor_stand,tag=marker_withering_animation] run kill @e[type=minecraft:item_display,distance=..5]
execute as @s[scores={enchantment.withering_VFX=22}] run kill @e[type=armor_stand,tag=marker_withering_animation]
execute as @s[scores={enchantment.withering_VFX=22}] run kill @e[type=item_display,tag=marker_withering_animation]
