...
# execute at @e[scores={enchantment_withering_animation=80},type=armor_stand,tag=marker_withering_animation] run kill @e[type=minecraft:item_display,distance=..5]
execute as @s[scores={enchantment_withering_animation=22}] run kill @e[type=armor_stand,tag=marker_withering_animation]
execute as @s[scores={enchantment_withering_animation=22}] run kill @e[type=item_display,tag=marker_withering_animation]

# execute as @s[scores={enchantment_withering_animation=22}] run tp @e[type=armor_stand,tag=marker_withering_animation] ~ -255 ~
execute as @s[scores={enchantment_withering_animation=82}] run scoreboard players reset @s enchantment_withering_animation