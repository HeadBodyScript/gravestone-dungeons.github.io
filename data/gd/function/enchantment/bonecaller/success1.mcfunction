...
effect give @e[distance=.5..10] minecraft:wither 20 3 true
effect give @e[distance=.5..10] minecraft:darkness 10 0 true
effect give @e[distance=.5..10] minecraft:slowness 5 2 true
