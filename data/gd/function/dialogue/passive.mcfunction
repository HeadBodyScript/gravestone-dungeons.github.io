# NOTE: this file is basically untouched, you coded this well
...
execute if entity @e[type=villager,distance=..4,tag=elana,limit=1,sort=nearest] run function gd:dialogue/passive/elana
