...
execute if score @s DIMI <= MP.bow DIMI if score .INT1 number matches 1 run item modify entity @s weapon.mainhand gd:stat/item/weapon/bow/mastercrafted
execute if score @s DIMI <= MP.bow DIMI if score .INT1 number matches 2 run item modify entity @s weapon.mainhand gd:stat/item/weapon/bow/exquisite
execute if score @s DIMI <= MP.bow DIMI if score .INT1 number matches 3 run item modify entity @s weapon.mainhand gd:stat/item/weapon/bow/legendary
