...
execute as @s[scores={tick=0..60}] run function gd:class/wizard/ability/warp/particle0
...
execute as @s[scores={tick=61..120}] run function gd:class/wizard/ability/warp/particle1
execute as @s[scores={tick=120}] run playsound minecraft:block.amethyst_block.hit master @p ~ ~ ~ 20

execute as @s[scores={tick=121..180}] run function gd:class/wizard/ability/warp/particle2
...
execute as @s[scores={tick=181..240}] run function gd:class/wizard/ability/warp/particle3
...
execute as @a at @s if score @s ability.link = @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=marker_ability_warp] ability.link run function gd:class/wizard/ability/warp/particle

execute as @s[scores={tick=235}] as @a at @s if score @s ability.link = @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=marker_ability_warp] ability.link run function gd:class/wizard/ability/warp/effect1
