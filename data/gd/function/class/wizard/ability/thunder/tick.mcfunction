...
execute as @e[type=#gd:mobs,distance=..6] at @s unless score @s ability.link = @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=marker_ability_thunder] ability.link run function gd:class/wizard/ability/thunder/effect
function gd:class/wizard/ability/thunder/particle
