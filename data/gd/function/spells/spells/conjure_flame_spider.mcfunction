...
execute at @e[type=armor_stand,tag=conjure_flame_spider] run tp @e[type=armor_stand,tag=conjure_flame_spider] ^ ^0.20 ^ ~12 ~
...
execute as @a[scores={conjure=25..}] run kill @e[type=armor_stand,tag=conjure_flame_spider,limit=2,sort=nearest]
