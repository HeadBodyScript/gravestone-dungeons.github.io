...
data merge entity @s {CustomName:'{"text":"Majestic Donkey","color":"gold","italic":false}',CustomNameVisible:0b}
...
execute as @p run say Seems like my foal has acquired majestic attributes...