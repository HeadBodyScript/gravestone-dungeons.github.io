...
data merge entity @s {CustomName:'{"text":"Resilient Camel","color":"#339900","italic":false}',CustomNameVisible:0b}
...
execute as @p run say Seems like my calf has acquired resilient attributes...