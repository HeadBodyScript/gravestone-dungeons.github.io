...
execute if score @s tick1 matches 1 run playsound minecraft:entity.blaze.shoot ambient @a[distance=..48] ~ ~ ~ 30 .1
...
execute if score @s tick1 matches 20 run playsound minecraft:entity.blaze.shoot ambient @a[distance=..48] ~ ~ ~ 30 .1
...
execute if score @s tick1 matches 30 run playsound minecraft:entity.blaze.shoot ambient @a[distance=..48] ~ ~ ~ 30 .1
...
execute if score @s tick1 matches 40 run playsound minecraft:entity.blaze.shoot ambient @a[distance=..48] ~ ~ ~ 30 .1
...
execute if score @s tick1 matches 50 run playsound minecraft:entity.blaze.shoot ambient @a[distance=..48] ~ ~ ~ 30 .1
