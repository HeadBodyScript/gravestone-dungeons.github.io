...
execute if score @s tick1 matches 20 run playsound minecraft:entity.blaze.shoot ambient @a ~ ~ ~ 30 .1
execute if score @s tick1 matches 20 as @e[type=armor_stand,tag=attack.devil.dart,tag=2] at @s run tp @s ^ ^ ^ facing entity @p eyes
execute if score @s tick1 matches 20..60 as @e[type=armor_stand,tag=attack.devil.dart,tag=2] at @s run tp @s ^ ^-.07 ^.7 ~ ~.5
...
execute if score @s tick1 matches 30 run playsound minecraft:entity.blaze.shoot ambient @a ~ ~ ~ 30 .1
execute if score @s tick1 matches 30 as @e[type=armor_stand,tag=attack.devil.dart,tag=3] at @s run tp @s ^ ^ ^ facing entity @p eyes
execute if score @s tick1 matches 30..70 as @e[type=armor_stand,tag=attack.devil.dart,tag=3] at @s run tp @s ^ ^-.06 ^.7 ~ ~.5
...
execute if score @s tick1 matches 40 run playsound minecraft:entity.blaze.shoot ambient @a ~ ~ ~ 30 .1
execute if score @s tick1 matches 40 as @e[type=armor_stand,tag=attack.devil.dart,tag=4] at @s run tp @s ^ ^ ^ facing entity @p eyes
execute if score @s tick1 matches 40..85 as @e[type=armor_stand,tag=attack.devil.dart,tag=4] at @s run tp @s ^ ^-.06 ^.7 ~ ~.5
...
execute if score @s tick1 matches 50 run playsound minecraft:entity.blaze.shoot ambient @a ~ ~ ~ 30 .1
execute if score @s tick1 matches 50 as @e[type=armor_stand,tag=attack.devil.dart,tag=5] at @s run tp @s ^ ^ ^ facing entity @p eyes
execute if score @s tick1 matches 50..100 as @e[type=armor_stand,tag=attack.devil.dart,tag=5] at @s run tp @s ^ ^-.06 ^.7 ~ ~.5
