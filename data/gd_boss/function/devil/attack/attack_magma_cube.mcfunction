...
execute if score @s tick3 matches 1 run particle minecraft:lava ~ ~ ~ .2 1 .2 .1 150
execute if score @s tick3 matches 1..5 if score @s randomNumber matches 1 at @e[type=marker,tag=marker.boss,tag=devil] run summon magma_cube ^1 ^12 ^ {Size:0,Tags:["devil_flame"],active_effects:[{id:slow_falling,duration:10,amplifier:0,ambient:1b,show_particles:1b}]}
execute if score @s tick3 matches 1..5 if score @s randomNumber matches 2 at @e[type=marker,tag=marker.boss,tag=devil] run summon magma_cube ^ ^12 ^ {Size:1,Tags:["devil_flame"],active_effects:[{id:"minecraft:oozing",amplifier:0,duration:10,show_particles:0b,show_icon:0b,ambient:0b}]}
execute if score @s tick3 matches 1..5 if score @s randomNumber matches 3 at @e[type=marker,tag=marker.boss,tag=devil] run summon magma_cube ^2 ^12 ^-1 {Size:2,Tags:["devil_flame"],active_effects:[{id:slow_falling,duration:10,amplifier:0,ambient:1b,show_particles:1b}]}
execute if score @s tick3 matches 1..5 if score @s randomNumber matches 4 at @e[type=marker,tag=marker.boss,tag=devil] run summon magma_cube ^-1 ^12 ^2 {Size:3,Tags:["devil_flame"],active_effects:[{id:slow_falling,duration:10,amplifier:0,ambient:1b,show_particles:1b}]}
...
execute if score @s tick3 matches 1..5 run playsound minecraft:entity.magma_cube.squish ambient @s ~ ~ ~ 30 .5
execute if score @s tick3 matches 15..18 run playsound minecraft:entity.magma_cube.squish ambient @s ~ ~ ~ 30 .5
execute if score @s tick3 matches 30..33 run playsound minecraft:entity.magma_cube.squish ambient @s ~ ~ ~ 30 .5
execute if score @s tick3 matches 45..51 run playsound minecraft:entity.magma_cube.squish ambient @s ~ ~ ~ 30 .5
