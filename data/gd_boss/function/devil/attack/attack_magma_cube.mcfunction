...
execute if score @s tick3 matches 1..5 run playsound minecraft:entity.magma_cube.squish ambient @a[distance=..48] ~ ~ ~ 30 .5
execute if score @s tick3 matches 15..18 run playsound minecraft:entity.magma_cube.squish ambient @a[distance=..48] ~ ~ ~ 30 .5
execute if score @s tick3 matches 30..33 run playsound minecraft:entity.magma_cube.squish ambient @a[distance=..48] ~ ~ ~ 30 .5
execute if score @s tick3 matches 45..51 run playsound minecraft:entity.magma_cube.squish ambient @a[distance=..48] ~ ~ ~ 30 .5
