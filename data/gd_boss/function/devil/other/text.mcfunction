...
execute if score @s randomNumber matches 8 as @s run tellraw @a[tag=fighting.devil] ["",{"text":"Blazing Devil","color":"gold"},{"text":" : xxx"}]
execute if score @s randomNumber matches 9 as @s run tellraw @a[tag=fighting.devil] ["",{"text":"Blazing Devil","color":"gold"},{"text":" : xxx"}]
execute if score @s randomNumber matches 10 as @s run tellraw @a[tag=fighting.devil] ["",{"text":"Blazing Devil","color":"gold"},{"text":" : xxx"}]
execute if score @s randomNumber matches 11 as @s run tellraw @a[tag=fighting.devil] ["",{"text":"Blazing Devil","color":"gold"},{"text":" : xxx"}]
execute if score @s randomNumber matches 12 as @s run tellraw @a[tag=fighting.devil] ["",{"text":"Blazing Devil","color":"gold"},{"text":" : xxx"}]