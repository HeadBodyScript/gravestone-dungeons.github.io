...
execute if score @s bossTick matches 500..800 run tp @s ~ ~0.01 ~ ~5 ~
execute if score @s bossTick matches 500..800 run function gd_boss:devil/other/vfx_fire_sphere
execute if score @s bossTick matches 800 run particle minecraft:lava ~ ~1 ~ .3 .3 .3 1 150
execute if score @s bossTick matches 250..850 run particle minecraft:ash ~ ~4 ~ 6 6 6 .3 5
