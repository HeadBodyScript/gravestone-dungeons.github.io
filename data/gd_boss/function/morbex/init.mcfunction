...
execute as @s[tag=!TRUE,tag=UNLOCKED] at @s if entity @a[distance=..5] run function gd_boss:morbex/setup
...
execute at @s[tag=!TRUE] as @a[distance=..12] run function gd_boss:morbex/other/intro