...
particle dust_color_transition{from_color: [.45f, .2f, .5f], scale: 1.2f, to_color: [.2f, .2f, .2f]} ~ ~2 ~ .2 1 .2 0 30 force
...
execute if score @s bossTick matches 18 at @s run summon armor_stand ~ ~1 ~ {NoGravity:0b,Invulnerable:1b,ShowArms:0b,Small:1b,Invisible:1b,Tags:["armorstand.quartz"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:quartz",count:1,components:{"minecraft:custom_model_data":2}}],Motion:[0.8,0.4,0.0]}
execute if score @s bossTick matches 18 at @s run summon armor_stand ~ ~1 ~ {NoGravity:0b,Invulnerable:1b,ShowArms:0b,Small:1b,Invisible:1b,Tags:["armorstand.quartz"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:quartz",count:1,components:{"minecraft:custom_model_data":3}}],Motion:[-0.5,0.4,0.866]}
execute if score @s bossTick matches 18 at @s run summon armor_stand ~ ~1 ~ {NoGravity:0b,Invulnerable:1b,ShowArms:0b,Small:1b,Invisible:1b,Tags:["armorstand.quartz"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:quartz",count:1,components:{"minecraft:custom_model_data":4}}],Motion:[-0.5,0.4,-0.866]}
...
execute if score @s bossTick matches 45..450 as @e[type=armor_stand,tag=armorstand.quartz] at @s anchored eyes facing entity @e[type=armor_stand,tag=armor_stand.boss,limit=1, sort=nearest] eyes positioned ^.7 ^.3 ^.9 rotated as @s positioned ^ ^ ^6 facing entity @s eyes facing ^ ^ ^-.5 positioned as @s run tp @s ^ ^ ^.1 ~ ~
#execute if score @s bossTick matches 450.. at @e[type=armor_stand,tag=armor_stand.boss] run tp @e[type=armor_stand,tag=armorstand.quartz] ~ ~-1 ~
execute if score @s bossTick matches 451 at @e[type=armor_stand,tag=armor_stand.boss] run tp @e[type=armor_stand,tag=armorstand.quartz] ~ ~-1 ~ facing entity @p eyes
