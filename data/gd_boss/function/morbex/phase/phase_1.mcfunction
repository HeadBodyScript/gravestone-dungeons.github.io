...
execute if score @s bossTick matches 500 run playsound minecraft:entity.ravager.roar ambient @a[distance=..32] ~ ~ ~ 20 0.1
...
execute if score @s bossTick matches 450 at @e[type=minecraft:marker,tag=marker.barrier,distance=..32] run playsound minecraft:entity.illusioner.prepare_blindness ambient @a[distance=..32] ~ ~ ~ 30 1
...
execute if score @s bossTick matches 600 run playsound minecraft:block.beacon.activate ambient @a[distance=..32] ~ ~ ~ 20 1
execute if score @s bossTick matches 680 run playsound minecraft:block.beacon.power_select ambient @a[distance=..32] ~ ~ ~ 20 1
...
execute if score @s bossTick matches 690 run playsound minecraft:block.bell.use ambient @a[distance=..32] ~ ~ ~ 20 1
