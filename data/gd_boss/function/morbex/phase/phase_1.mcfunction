...
execute if score @s bossTick matches 700..710 store result entity @e[limit=1,tag=boss.morbex] attributes[{id:"minecraft:generic.max_health"}].base int 1 run scoreboard players get morbex.boss.health INT
