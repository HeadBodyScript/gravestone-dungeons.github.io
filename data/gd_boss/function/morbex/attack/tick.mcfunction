...
execute if score @s tick matches 1 if score @s randomNumber matches 2 run effect give @a[distance=..40] hunger 10 50 true
execute if score @s[tag=!ring] tick matches 1 if score @s randomNumber matches 3 run tag @s add ring
execute if score @s tick matches 1 if score @s randomNumber matches 4 run effect give @e[type=illusioner,tag=boss.morbex,distance=..32] levitation 5 8 true
execute if score @s tick matches 1 if score @s randomNumber matches 4 run effect give @e[type=illusioner,tag=boss.morbex,distance=..32] slow_falling 10 8 true
...
execute if score @s tick matches 1 if score @s randomNumber matches 7 run function gd_boss:morbex/attack/morbex_summon
execute if score @s tick matches 1 if score @s randomNumber matches 8 run function gd_boss:morbex/attack/morbex_hoglin

execute if score @s[tag=!sphere] tick matches 1 if score @s randomNumber matches 9 run tag @s add sphere
execute if score @s tick matches 1 if score @s randomNumber matches 9 at @e[tag=marker.boss,distance=..32] run summon armor_stand ~ ~4 ~ {Invisible:true,Invulnerable:true,NoGravity:true,Marker:true,Tags:["morbex_sphere"]}
execute if score @s[tag=!sphere] tick matches 1 if score @s randomNumber matches 10 at @e[tag=marker.boss,distance=..32] run function gd_enchantment:void_sphere/summon

execute if score @s tick matches 1 if score @s randomNumber matches 6.. run function gd_boss:morbex/other/text
