...
execute as @s[scores={tick1=300}] at @e[type=bat,tag=minion.morbex] run summon vex ~ ~ ~ {Tags:["minion.morbex"]}

execute as @s[scores={tick1=300}] run kill @e[type=bat,tag=minion.morbex]
execute as @s[scores={tick1=500}] run kill @e[type=vex,tag=minion.morbex]
execute as @s[scores={tick1=500..}] run scoreboard players reset @s tick1
execute as @s[scores={tick1=500}] run tag @s remove trick