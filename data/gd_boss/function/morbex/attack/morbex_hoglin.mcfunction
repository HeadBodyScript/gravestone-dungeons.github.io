...
execute at @e[tag=marker.minion,tag=morbex,distance=..32] particle dust_color_transition{from_color: [.45f, .2f, .5f], scale: 1.5f, to_color: [.2f, .2f, .2f]} ~ ~.5 ~ .2 1 .2 0 100 force
