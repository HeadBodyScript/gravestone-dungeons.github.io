...
execute as @a[scores={tick2=2}] at @e[type=armor_stand,tag=morbex_void_sphere] run playsound minecraft:entity.ghast.death ambient @a[distance=..20] ~ ~ ~ 20 .5
execute as @a[scores={tick2=75}] at @e[type=armor_stand,tag=morbex_void_sphere] run playsound minecraft:entity.illusioner.cast_spell ambient @a[distance=..20] ~ ~ ~ 20 1
execute as @a[scores={tick2=150}] at @e[type=armor_stand,tag=morbex_void_sphere] run playsound minecraft:entity.enderman.death master @a[distance=..40] ~ ~ ~ 60 .1
...
execute as @e[scores={tick2=100}] at @e[type=armor_stand,tag=morbex_void_sphere] run playsound minecraft:entity.enderman.stare master @a[distance=..30] ~ ~ ~ 40 .1
execute as @e[scores={tick2=400}] at @e[type=armor_stand,tag=morbex_void_sphere] run playsound minecraft:entity.enderman.stare master @a[distance=..30] ~ ~ ~ 40 .1
