...
execute as @s[scores={tick3=2}] run playsound minecraft:entity.breeze.inhale master @a[distance=..24] ~ ~ ~ 20 1
execute as @s[scores={tick3=2}] run playsound minecraft:block.amethyst_block.chime master @a[distance=..24] ~ ~ ~ 20 1
...
execute as @s[scores={tick3=60}] run playsound minecraft:entity.breeze.idle_ground master @a[distance=..24] ~ ~ ~ 20 2
execute as @s[scores={tick3=60}] run playsound minecraft:block.amethyst_block.resonate master @a[distance=..24] ~ ~ ~ 20 1.5
...
execute as @s[scores={tick3=160}] run playsound minecraft:entity.breeze.inhale master @a[distance=..24] ~ ~ ~ 20 1.5
execute as @s[scores={tick3=160}] run playsound minecraft:block.amethyst_block.chime master @a[distance=..24] ~ ~ ~ 20 1
...
execute as @s[scores={tick3=260}] run playsound minecraft:entity.breeze.inhale master @a[distance=..24] ~ ~ ~ 20 2
execute as @s[scores={tick3=260}] run playsound minecraft:block.amethyst_block.resonate master @a[distance=..24] ~ ~ ~ 20 1.5
...
execute as @s[scores={tick3=350}] run playsound minecraft:entity.breeze.idle_ground master @a[distance=..24] ~ ~ ~ 20 1
execute as @s[scores={tick3=350}] run playsound minecraft:block.amethyst_block.resonate master @a[distance=..24] ~ ~ ~ 20 1.5
...
execute as @s[scores={tick3=450}] run playsound minecraft:entity.breeze.inhale master @a[distance=..24] ~ ~ ~ 20 1.5
execute as @s[scores={tick3=450}] run playsound minecraft:block.amethyst_block.chime master @a[distance=..24] ~ ~ ~ 20 1
...
execute as @s[scores={tick3=580}] run playsound minecraft:entity.breeze.idle_ground master @a[distance=..24] ~ ~ ~ 20 2
execute as @s[scores={tick3=580}] run playsound minecraft:block.amethyst_block.chime master @a[distance=..24] ~ ~ ~ 20 1.5
execute as @s[scores={tick3=700}] run tellraw @s ["",{"text":"Morbex","color":"#6F0C99"},{"text":" : Don't let me alone!"}]
execute as @s[scores={tick3=700}] run playsound minecraft:entity.breeze.inhale master @a[distance=..24] ~ ~ ~ 20 1
execute as @s[scores={tick3=700}] run playsound minecraft:block.amethyst_block.resonate master @a[distance=..24] ~ ~ ~ 20 1.5
