...
tellraw @a[tag=fighting.morbex] ["",{"text":"BOSS","color":"gold"},{"text":" : That's impossible! You cannot defeat me, I have the power of the gods! And you're just a pathetic... arrggh.."}]
tellraw @a[tag=fighting.morbex] ["",{"selector":"@s","color":"gold"},{"text":" : Apparently, not as strong as you thought.. "}]
tellraw @a[tag=fighting.morbex] ["",{"selector":"@s","color":"gold"},{"text":" : Maybe someone will pay me well for his mask..."}]
