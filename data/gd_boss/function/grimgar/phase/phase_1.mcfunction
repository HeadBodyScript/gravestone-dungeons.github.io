...
execute at @e[type=minecraft:armor_stand,limit=1,sort=nearest,tag=armor_stand.boss,tag=grimgar] run function gd_boss:grimgar/phase/phase_1_vfx
...
execute if score @s bossTick matches 140 run playsound minecraft:bells ambient @a ~ ~ ~ 10 1
execute if score @s bossTick matches 150 run playsound minecraft:bells ambient @a ~ ~ ~ 10 1
