...
execute if score @s bossTick matches ..90 run scoreboard objectives add grimgar6 minecraft.custom:minecraft.play_time
...
execute if score @s bossTick matches 1 run say Ahhhhhrg! Buggers like you bother me here over and over again! 
execute if score @s bossTick matches 90 run say None of your predecessors will ever bother anyone again and now it's time for you to... "disappear".
