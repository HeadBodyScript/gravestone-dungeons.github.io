...
execute if score @s bossTick matches 1 run tellraw @a ["",{"text":"BOSS","color":"gold"},{"text":" : Ahhhhhrg! Buggers like you bother me here over and over again! "}]
execute if score @s bossTick matches 90 run tellraw @a ["",{"text":"BOSS","color":"gold"},{"text":" : None of your predecessors will ever bother anyone again and now it's time for you to... disappear."}]
