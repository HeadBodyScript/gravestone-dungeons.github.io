...
execute if score @s bossTick matches 1 run say I see you're not that easy to dispatch..
...
execute if score @s bossTick matches 50 run playsound minecraft:ambient.warped_forest.mood master @a ~ ~ ~ 8 2
execute if score @s bossTick matches 50 run playsound minecraft:ambient.warped_forest.mood master @a ~ ~ ~ 8 2
execute if score @s bossTick matches 90 run say Let's see how long you last against one of my champions.
...
execute if score @s bossTick matches 100 run function gd_boss:grimgar/phase/mini_boss
