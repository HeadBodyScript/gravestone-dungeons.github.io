...
execute if score @s randomNumber matches 1 run tellraw @a ["",{"text":"BOSS","color":"gold"},{"text":" : Something is chasing you... and you can't run away!"}]
execute if score @s randomNumber matches 1 run tellraw @a ["",{"text":"BOSS","color":"gold"},{"text":" : Take that! "}]
execute if score @s randomNumber matches 1 run tellraw @a ["",{"text":"BOSS","color":"gold"},{"text":" : Do you feel the cold breath? The Grim Reaper is on his way to you."}]
