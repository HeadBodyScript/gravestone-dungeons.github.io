...
tellraw @a[tag=fighting.grimgar] ["",{"text":"Grimgar","color":"gold"},{"text":" : That's impossible! You cannot defeat me, I have the power of the gods! And you're just a pathetic... arrggh.."}]
