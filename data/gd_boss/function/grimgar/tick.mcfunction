...
execute if score @s tick = grimgar.attack.cooldown INT if score .INT0 randomNumber matches 1 as @a[distance=..32,limit=1] at @s run function gd_boss:grimgar/attack/attack_evoker_fang
...
execute if score @s[tag=phase_5] tick = grimgar.attack.cooldown INT if score .INT0 randomNumber matches 4 as @e[type=minecraft:evoker,tag=boss.grimgar] run function gd_boss:grimgar/attack/attack_warp
