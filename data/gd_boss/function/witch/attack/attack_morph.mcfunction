...
execute as @s[tag=witch_1] if score @s tick1 matches 1 run playsound minecraft:entity.elder_guardian.curse master @a ~ ~ ~ 15 1.5
...
execute as @s[tag=witch_2] if score @s tick1 matches 1 run playsound minecraft:entity.elder_guardian.curse master @a ~ ~ ~ 15 1.5
...
execute as @s[tag=witch_3] if score @s tick1 matches 1 run playsound minecraft:entity.elder_guardian.curse master @a ~ ~ ~ 15 1.5
