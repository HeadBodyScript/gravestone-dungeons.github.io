...
execute as @s[scores={tick2=1}] at @e[type=armor_stand,tag=2] run playsound minecraft:entity.player.attack.sweep master @a[distance=..10] ~ ~ ~ 20 .5
execute as @s[scores={tick2=1}] at @e[type=armor_stand,tag=1] run tp @e[type=armor_stand,tag=1] ^ ^ ^ facing entity @p eyes
execute as @s[scores={tick2=1..50}] at @e[type=armor_stand,tag=1] run tp @e[type=armor_stand,tag=1] ^ ^-.05 ^.7 ~ ~.5
...
execute as @s[scores={tick2=11}] at @e[type=armor_stand,tag=2] run playsound minecraft:entity.player.attack.sweep master @a[distance=..10] ~ ~ ~ 20 .5
