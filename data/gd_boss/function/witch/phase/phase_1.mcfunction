...
execute as @s[scores={bossTick=1}] store result score @s randomNumber run random value 1..3
...
execute if score @s bossTick matches 60 if score @s randomNumber matches 1 run tellraw @a[tag=fighting.witch] ["",{"text":"Kaidaia","color":"#ff0033"},{"text":" : Ah, such delightful visitors."}] 
execute if score @s bossTick matches 160 if score @s randomNumber matches 1 run tellraw @a[tag=fighting.witch] ["",{"text":"Kaidaia","color":"#ff0033"},{"text":" : Every word I whisper is laced with sweetness... and just a hint of venom."}] 
execute if score @s bossTick matches 290 if score @s randomNumber matches 1 run tellraw @a[tag=fighting.witch] ["",{"text":"Kaidaia","color":"#ff0033"},{"text":" : Come closer, let me weave a spell around you."}] 
execute if score @s bossTick matches 400 if score @s randomNumber matches 1 run tellraw @a[tag=fighting.witch] ["",{"text":"Kaidaia","color":"#ff0033"},{"text":" : Don’t worry, the bite is only fatal if you resist."}] 

execute if score @s bossTick matches 60 if score @s randomNumber matches 2 run tellraw @a[tag=fighting.witch] ["",{"text":"Malificaia","color":"#9966cc"},{"text":" : Did you really think you could trespass here unscathed?"}] 
execute if score @s bossTick matches 160 if score @s randomNumber matches 2 run tellraw @a[tag=fighting.witch] ["",{"text":"Malificaia","color":"#9966cc"},{"text":" : Foolish mortals, daring to step into my domain."}] 
execute if score @s bossTick matches 290 if score @s randomNumber matches 2 run tellraw @a[tag=fighting.witch] ["",{"text":"Malificaia","color":"#9966cc"},{"text":" : Your courage will soon turn to ash as my spells twist your fate."}] 
execute if score @s bossTick matches 400 if score @s randomNumber matches 2 run tellraw @a[tag=fighting.witch] ["",{"text":"Malificaia","color":"#9966cc"},{"text":" : Prepare to suffer under the weight of your mistakes."}] 

execute if score @s bossTick matches 60 if score @s randomNumber matches 3 run tellraw @a[tag=fighting.witch] ["",{"text":"Sylvanaia","color":"#0099cc"},{"text":" : Ugh, more interruptions."}] 
execute if score @s bossTick matches 160 if score @s randomNumber matches 3 run tellraw @a[tag=fighting.witch] ["",{"text":"Sylvanaia","color":"#0099cc"},{"text":" : As if this day couldn’t get worse."}] 
execute if score @s bossTick matches 290 if score @s randomNumber matches 3 run tellraw @a[tag=fighting.witch] ["",{"text":"Sylvanaia","color":"#0099cc"},{"text":" : I’ve neither the patience nor the mercy for fools who cross me."}] 
execute if score @s bossTick matches 400 if score @s randomNumber matches 3 run tellraw @a[tag=fighting.witch] ["",{"text":"Sylvanaia","color":"#0099cc"},{"text":" : So, unless you enjoy pain, prepare to regret every step you’ve taken toward me!"}] 
