...
execute if score @s bossTick matches 120 run playsound minecraft:entity.blaze.shoot master @a[distance=..30] ~ ~ ~ 10 0
...
execute if score @s bossTick matches 140 run playsound minecraft:entity.blaze.shoot master @a[distance=..30] ~ ~ ~ 10 0
...
execute if score @s bossTick matches 160 run playsound minecraft:entity.blaze.shoot master @a[distance=..30] ~ ~ ~ 10 0
...
execute if score @s bossTick matches 180 run playsound minecraft:entity.blaze.shoot master @a[distance=..30] ~ ~ ~ 10 0
...
execute if score @s bossTick matches 200 run playsound minecraft:entity.blaze.shoot master @a[distance=..30] ~ ~ ~ 10 0
...
execute if score @s bossTick matches 220 run playsound minecraft:entity.blaze.shoot master @a[distance=..30] ~ ~ ~ 10 0
...
execute if score @s bossTick matches 240 run playsound minecraft:entity.blaze.shoot master @a[distance=..30] ~ ~ ~ 10 0
...
execute if score @s bossTick matches 260 run playsound minecraft:entity.blaze.shoot master @a[distance=..30] ~ ~ ~ 10 0
...
execute if score @s bossTick matches 318 at @s run summon wither_skeleton ~ ~ ~ {Team:ENEMY,active_effects:[{id:resistance,duration:999999,amplifier:255,show_particles:0b}],NoAI:1b,NoGravity:1b,Invulnerable:1b,LeftHanded:1b,PersistenceRequired:1b,Health:1024f,Tags:["boss.marrow","boss"],CustomName:'{"color":"#4A9400","text":"Blighted Marrow"}',HandItems:[{id:"minecraft:netherite_sword",count:1,components:{"minecraft:enchantments":{levels:{"gd_enchantment:bleeding":1}},"minecraft:enchantment_glint_override":false,"minecraft:attribute_modifiers":[{id:"entity_interaction_range",type:"player.entity_interaction_range",amount:1,operation:"add_value",slot:"hand"},{id:"attack_damage",type:"generic.attack_damage",amount:16,operation:"add_value"}]}},{id:"minecraft:shield",count:1,components:{"minecraft:enchantments":{levels:{"minecraft:unbreaking":2}},"minecraft:enchantment_glint_override":false,"minecraft:base_color":"green","minecraft:banner_patterns":[{pattern:globe,color:black},{pattern:curly_border,color:black},{pattern:small_stripes,color:black},{pattern:rhombus,color:black},{pattern:stripe_bottom,color:black},{pattern:circle,color:green}]}}],HandDropChances:[0F,0F],ArmorItems:[{id:"minecraft:leather_boots",count:1},{id:"minecraft:netherite_leggings",count:1},{id:"minecraft:netherite_chestplate",count:1},{id:"minecraft:chainmail_helmet",count:1}],ArmorDropChances:[0f,0f,0f,0f],attributes:[{id:"minecraft:generic.armor",base:30},{id:"minecraft:generic.armor_toughness",base:3},{id:"minecraft:generic.attack_damage",base:20},{id:"minecraft:generic.follow_range",base:32},{id:"minecraft:generic.jump_strength",base:0.6},{id:"minecraft:generic.knockback_resistance",base:0.2},{id:"minecraft:generic.max_health",base:1024},{id:"minecraft:generic.movement_speed",base:0.20},{id:"minecraft:generic.safe_fall_distance",base:10},{id:"minecraft:generic.scale",base:1.2},{id:"minecraft:generic.water_movement_efficiency",base:0.8}]}

execute if score @s bossTick matches 320..320 store result entity @e[limit=1,tag=boss.marrow] attributes[{id:"minecraft:generic.max_health"}].base int 1 run scoreboard players get marrow.boss.health INT
