...
execute if score @s[tag=!leap] tick matches 1 if score @s randomNumber matches 2 run tag @s add leap
execute if score @s[tag=!leap] tick matches 1 if score @s randomNumber matches 3 run tag @s add leap
execute if score @s[tag=!throw] tick matches 1 if score @s randomNumber matches 4 run tag @s add throw
execute if score @s[tag=!throw] tick matches 1 if score @s randomNumber matches 5 run tag @s add throw
execute if score @s[tag=!throw] tick matches 1 if score @s randomNumber matches 7 run tag @s add throw
execute if score @s[tag=!shout] tick matches 1 if score @s randomNumber matches 7 run tag @s add shout
execute if score @s[tag=!warp] tick matches 1 if score @s randomNumber matches 8 run tag @s add warp
execute if score @s[tag=!warp] tick matches 1 if score @s randomNumber matches 9 run tag @s add warp
execute if score @s[tag=!shout] tick matches 1 if score @s randomNumber matches 9 run tag @s add shout
