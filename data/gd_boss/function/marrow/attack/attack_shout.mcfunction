...
execute if score @s tick1 matches 40 run playsound minecraft:entity.ender_dragon.growl master @a ~ ~ ~ 50 0.001
execute if score @s tick1 matches 38 run playsound minecraft:entity.skeleton_horse.death master @a ~ ~ ~ 50 0.5
...
execute if score @s tick1 matches 40 run effect give @s minecraft:resistance 6 10 true
