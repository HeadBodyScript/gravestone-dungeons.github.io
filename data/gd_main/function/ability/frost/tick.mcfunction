...
# execute as @e[type=arrow,nbt=!{inGround:1b},distance=..5] run data merge entity @s[type=arrow] {item:{components:{"minecraft:custom_data":{fire_arrow:0b,frostbite_arrow:1b,lightning_arrow:0b}}}}
