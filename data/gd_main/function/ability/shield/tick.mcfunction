...
execute as @e[distance=..8,type=!player,tag=!companion,tag=!boss,tag=!ability,tag=!marker.ability_frost,tag=!marker.ability_ember,tag=!marker.ability_shield,tag=!marker.ability_thunder,tag=!marker.ability_warp] run function gd_main:ability/shield/effect
