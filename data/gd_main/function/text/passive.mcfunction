...
execute as @s[scores={talked_to_villager_CD=-1}] if entity @e[type=villager,distance=..4,tag=duncan,limit=1,sort=nearest] run function gd_main:text/passive/duncan
