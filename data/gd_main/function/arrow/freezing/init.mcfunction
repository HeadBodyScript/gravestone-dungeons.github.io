# execute as @s[tag=arrow_freezing] run summon armor_stand ~ ~ ~ {Tags:["freezing_arrow_stand"],Invisible:1b,Passengers:[{id:"minecraft:item_display",Tags:["freezing_arrow_block"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-.2f,0f],scale:[1.2f,1.2f,1.2f]},item:{id:"minecraft:packed_ice"}},{id:"minecraft:item_display",Tags:["freezing_arrow_block"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-1.4f,0f],scale:[1.2f,1.2f,1.2f]},item:{id:"minecraft:packed_ice"}}]}
