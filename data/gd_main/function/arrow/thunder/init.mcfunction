...
execute if entity @s[type=!player,tag=arrow_thunder] run damage @s 12 minecraft:lightning_bolt
execute if entity @s[type=player,tag=arrow_thunder] run damage @s 6 minecraft:lightning_bolt
