...
execute if entity @s[type=!player,tag=arrow_fire] run damage @s 12 minecraft:in_fire
execute if entity @s[type=player,tag=arrow_fire] run damage @s 6 minecraft:in_fire
