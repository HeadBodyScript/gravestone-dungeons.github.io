give @s potion[max_stack_size=1,custom_name='{"color":"#4DCFDE","italic":true,"text":"Moderate Frostbite Oil"}',lore=['{"color":"gray","italic":false,"text":" ❄ Weapon Oil"}','{"color":"gray","italic":false,"text":"Used to add a frostbite effect"}','{"color":"gray","italic":false,"text":"for 250 hits to a weapon."}','{"color":"gray","italic":false,"text":"Right click weapon with oil in offhand."}'],custom_model_data=5,custom_data={moderate_frostbite:1b},food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:100023},potion_contents={custom_color:5099486,custom_effects:[{id:"minecraft:slowness",amplifier:2,duration:240}]}] 1
...
kill @e[type=item,nbt={Item:{id:"minecraft:packed_ice",count:1}},sort=nearest,distance=..1.5]
