give @s potion[max_stack_size=1,custom_name='{"color":"#BDBD13","italic":true,"text":"Weak Holy Oil"}',lore=['{"color":"gray","italic":false,"text":" ❇ Weapon Oil"}','{"color":"gray","italic":false,"text":"Used to add a holy effect"}','{"color":"gray","italic":false,"text":"for 100 hits to a weapon."}','{"color":"gray","italic":false,"text":"Right click weapon with oil in offhand."}'],custom_model_data=5,custom_data={weak_holy:1b},food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:100023},potion_contents={custom_color:12434707,custom_effects:[{id:"minecraft:weakness",amplifier:0,duration:240}]}] 1
...
kill @e[type=item,nbt={Item:{id:"minecraft:golden_carrot",count:1}},sort=nearest,distance=..1.5]
