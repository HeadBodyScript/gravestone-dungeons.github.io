...
execute as @s[scores={tick=15}] run summon skeleton ~ ~-2.7 ~ {CustomName:'[{"text":"Poisonous Bow Guardian","color":"#336600"}]',Health:70,PersistenceRequired:1b,Tags:["companion"],DeathLootTable:"empty",Team:DIREWOOD,active_effects:[{id:invisibility,duration:-1,amplifier:0,ambient:1b,show_particles:1b}],HandItems:[{id:bow,components:{"minecraft:custom_model_data":1,enchantments:{levels:{"gd_enchantment:blackthorn_arrow":1}},"minecraft:enchantment_glint_override":false}},{}],HandDropChances:[0f,0f],ArmorItems:[{id:chainmail_boots,components:{enchantments:{levels:{unbreaking:10}}},count:1},{id:chainmail_leggings,components:{enchantments:{levels:{unbreaking:10}}},count:1},{id:chainmail_chestplate,components:{enchantments:{levels:{unbreaking:10}}},count:1},{id:chainmail_helmet,components:{enchantments:{levels:{unbreaking:10}}},count:1}],ArmorDropChances:[0f,0f,0f,0f],attributes:[{id:"generic.max_health",base:70f},{id:"minecraft:generic.scale",base:1.1}]}
