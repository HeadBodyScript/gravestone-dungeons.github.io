...
execute if score @s tick0 matches 2 at @e[type=armor_stand,tag=poisonblock] run tp @e[type=armor_stand,tag=poisonblock] ^ ^ ^ facing entity @e[type=#gd_main:companion_can_attack,tag=!companion,sort=nearest,limit=1] feet
