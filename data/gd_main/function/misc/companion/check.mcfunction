...
execute as @s[tag=conjure_lightning_mace] at @s run function gd_main:misc/companion/lightning_mace

execute as @s[tag=conjure_poison_bow] at @s run function gd_main:misc/companion/poison_bow
execute as @s[tag=conjure_frosty_bow] at @s run function gd_main:misc/companion/frosty_bow
execute as @s[tag=conjure_fiery_bow] at @s run function gd_main:misc/companion/fiery_bow
execute as @s[tag=conjure_lightning_bow] at @s run function gd_main:misc/companion/lightning_bow

execute as @s[tag=conjure_sparking_spider] at @s run function gd_main:misc/companion/sparking_spider
...
execute as @s[tag=conjure_naga_witch] at @s run function gd_main:misc/companion/naga_witch
execute as @s[tag=conjure_finnik_crossbowman] at @s run function gd_main:misc/companion/finnik_crossbowman
...
execute as @s[tag=conjure_lightning_golem] at @s run function gd_main:misc/companion/lightning_golem