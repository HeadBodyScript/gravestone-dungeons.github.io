...
scoreboard players set @s dummy_health_attribute 0
scoreboard players set @s dummy_magicka 0
scoreboard players set @s dummy_magicka_attribute 0
attribute @s minecraft:generic.safe_fall_distance modifier remove falldistance
scoreboard players set @s dummy_falldistance_attribute 0
execute as @s run attribute @s minecraft:player.block_interaction_range modifier remove range
scoreboard players set @s dummy_range_attribute 0
attribute @s minecraft:generic.oxygen_bonus modifier remove oxygen
scoreboard players set @s dummy_oxygen_attribute 0

clear @s sentry_armor_trim_smithing_template[minecraft:custom_data={stone_rune_delete:1b}] 1
