...
tp @s ~ ~0.1 ~ ~10 ~
execute as @s[scores={tick=1}] run playsound minecraft:entity.generic.swim master @a[distance=..12] ~ ~ ~ 10 1
execute as @s[scores={tick=15}] run playsound minecraft:entity.generic.splash master @a[distance=..12] ~ ~ ~ 10 .1
execute as @s[scores={tick=30}] run playsound minecraft:entity.generic.splash master @a[distance=..12] ~ ~ ~ 10 .8
execute as @s[scores={tick=1}] run playsound minecraft:entity.player.swim master @a[distance=..12] ~ ~ ~ 10
