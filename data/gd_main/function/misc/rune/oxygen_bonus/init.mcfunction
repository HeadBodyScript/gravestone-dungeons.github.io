...
execute if items entity @s weapon.mainhand minecraft:sentry_armor_trim_smithing_template[minecraft:custom_data={oxygen3:1b}] run scoreboard players add @s rune.oxygen_bonus 3
...
execute if items entity @s weapon.mainhand minecraft:sentry_armor_trim_smithing_template[minecraft:custom_data={oxygen5:1b}] run scoreboard players add @s rune.oxygen_bonus 5
