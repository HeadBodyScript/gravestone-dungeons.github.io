...
tp @s ~ ~0.1 ~ ~10 ~
execute as @s[scores={tick=1}] run playsound minecraft:block.conduit.deactivate master @a ~ ~ ~ 10 1
execute as @s[scores={tick=15}] run playsound minecraft:entity.slime.jump master @a ~ ~ ~ 10 .1
execute as @s[scores={tick=40}] run playsound minecraft:entity.slime.jump master @a ~ ~ ~ 10 .8
execute as @s[scores={tick=1}] run playsound minecraft:block.amethyst_block.resonate master @a ~ ~ ~ 10
