...
execute if score @s tick matches 1 at @e[type=minecraft:armor_stand,tag=armor_stand.modify] if entity @e[type=#gd_main:modify,tag=modify] run playsound minecraft:entity.elder_guardian.death ambient @a[distance=..20] ~ ~ ~ 40 0.5
