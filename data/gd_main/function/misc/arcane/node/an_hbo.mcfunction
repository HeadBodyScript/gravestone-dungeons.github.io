...
execute if score .INT0 randomNumber matches 1 run function gd_main:misc/arcane/reward/false/an_hbo
execute unless score .INT0 randomNumber matches 1 run function gd_main:misc/arcane/reward/true/an_hbo