...
execute if score @s tick6 matches 60.. if score @s mana matches 4000.. unless score @s enchantment.deflect_CD matches 0.. at @s if entity @e[type=#gd_main:entity,distance=..8] run function gd_enchantment:deflect_projectiles/success