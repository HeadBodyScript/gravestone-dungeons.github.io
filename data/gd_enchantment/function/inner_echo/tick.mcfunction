...
# Random
execute as @s[scores={talked_to_villager_CD=-1,talked_to_sword_CD=-1,talked_to_sword_equip_CD=100}] run function gd_main:text/passive/inner_echo/inner_echo_diamond
