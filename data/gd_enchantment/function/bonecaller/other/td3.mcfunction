...
particle soul ^ ^1 ^-0.5 .1 .1 .1 0.01 0 force
particle cloud ^ ^1 ^-0.5 .1 .1 .1 0.01 0 force
...
execute at @s as @e[type=#gd_main:entity,distance=..2] unless score @s UUID = @e[type=armor_stand,tag=projectile_bonecaller,limit=1,sort=nearest] UUID run function gd_enchantment:bonecaller/init1