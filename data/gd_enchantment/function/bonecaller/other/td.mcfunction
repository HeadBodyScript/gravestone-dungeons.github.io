...
execute at @s as @e[distance=..2] unless score @s UUID = @e[type=armor_stand,tag=projectile_bonecaller,limit=1,sort=nearest] UUID run function gd_enchantment:bonecaller/hit