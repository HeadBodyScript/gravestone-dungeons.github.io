...
execute store result score .INT randomNumber run random value 1..60
...
execute if score @s enchantment.frostbite_VFX matches 1 run playsound block.amethyst_block.chime master @a[distance=..10] ~ ~ ~ 20 1 0
execute if score @s enchantment.frostbite_VFX matches 1 at @s run summon armor_stand ~ ~ ~ {DisabledSlots:4144959,Tags:["marker_frostbite"],Invisible:1b,Passengers:[{id:"minecraft:item_display",Tags:["marker_frostbite"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-.2f,0f],scale:[1.2f,1.2f,1.2f]},item:{id:"minecraft:packed_ice"}},{id:"minecraft:item_display",Tags:["marker_frostbite"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-1.4f,0f],scale:[1.2f,1.2f,1.2f]},item:{id:"minecraft:packed_ice",}}]}
...
execute if score .INT randomNumber matches 1 at @s run playsound block.amethyst_block.place master @a[distance=..10] ~ ~ ~ 20 1.7 0
execute if score .INT randomNumber matches 2 at @s run playsound block.amethyst_block.place master @a[distance=..10] ~ ~ ~ 20 1.5 0
execute if score @s enchantment.frostbite_VFX matches 170 run data merge entity @s {NoAI:0b}
execute if score @s enchantment.frostbite_VFX matches 170 run playsound block.glass.break master @a[distance=..10] ~ ~1 ~ 0.8 1 0
...
# execute if score @s enchantment.frostbite_VFX matches 172.. run tag @s remove arrow_frostbite
