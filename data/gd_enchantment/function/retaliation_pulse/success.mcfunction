...
playsound minecraft:block.amethyst_cluster.fall master @a[distance=..20] ~ ~ ~ 20 .5
playsound minecraft:block.amethyst_cluster.fall master @a[distance=..20] ~ ~ ~ 20 1
playsound minecraft:block.amethyst_cluster.fall master @a[distance=..20] ~ ~ ~ 20 1.5
playsound minecraft:block.amethyst_block.resonate master @a[distance=..20] ~ ~ ~ 20 .5
