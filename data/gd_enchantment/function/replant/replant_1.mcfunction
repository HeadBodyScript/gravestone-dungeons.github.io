...
# execute as @p[scores={replant_sneak=2,seed_title=1,Wheat=1..}] run function gd:enchantments/replant/replant_w1
# execute as @p[scores={replant_sneak=2,seed_title=2,Carrots=1..}] run function gd:enchantments/replant/replant_c1
# execute as @p[scores={replant_sneak=2,seed_title=3,Potato=1..}] run function gd:enchantments/replant/replant_p1
# execute as @p[scores={replant_sneak=2,seed_title=4,Beet=1..}] run function gd:enchantments/replant/replant_b1
# execute as @p[scores={replant_sneak=2,seed_title=5,Wart=1..}] run function gd:enchantments/replant/replant_nw1
...
# execute if score @p seed_title matches 6.. run scoreboard players set @p seed_title 1

# execute unless items entity @p weapon.offhand gd:stat_item_item[minecraft:custom_data={modified:1b,enchantment:1b}] unless items entity @p weapon.mainhand gd:stat_item_item[minecraft:custom_data={modified:1b,enchantment:1b}] run item modify entity @s weapon.mainhand gd_enchantment:sickle
