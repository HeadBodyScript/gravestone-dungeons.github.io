...
execute if score @s mana matches 300.. if score @s enchantment.levitation_INT matches 60 run function gd_enchantment:levitation/other/vfx
execute unless predicate gd_main:is_sneaking if score @s mana matches 300.. if score @s enchantment.levitation_INT matches 60 run function gd_enchantment:levitation/success
