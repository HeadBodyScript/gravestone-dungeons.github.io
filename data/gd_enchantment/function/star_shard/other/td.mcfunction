...
execute as @s[scores={enchantment.star_shard_TD=21..}] at @s anchored eyes facing entity @e[type=#gd_main:entity,tag=!companion,limit=1,sort=nearest] eyes positioned ^.1 ^.8 ^.9 rotated as @s positioned ^ ^ ^2 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ^ ^ ^.4 ~ ~
