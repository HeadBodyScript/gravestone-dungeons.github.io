...
execute unless predicate gd_main:is_sneaking if score @s mana matches 800.. if score @s enchantment.fire_burst_INT matches 60 run function gd_enchantment:fire_burst/success
