...
execute as @s[scores={enchantment.light_wave_VFX=2}] run playsound block.beacon.power_select master @a[distance=..32] ~ ~ ~ 20 2 1
execute as @s[scores={enchantment.light_wave_VFX=2}] run playsound minecraft:entity.player.attack.knockback master @a[distance=..32] ~ ~ ~ 20 .5 1
