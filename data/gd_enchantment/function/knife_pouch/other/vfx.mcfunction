...
execute as @e[distance=..2] unless score @s enchantment.knife_pouch_UUID = @e[type=minecraft:armor_stand,limit=1,distance=..2.1] enchantment.knife_pouch_UUID run function gd_enchantment:knife_pouch/other/hit with storage minecraft:damage
