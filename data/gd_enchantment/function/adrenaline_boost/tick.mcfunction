execute if score @s enchantment.adrenaline_boost_INT matches 19 run playsound minecraft:item.armor.equip_iron master @s ~ ~ ~ 20 .7
execute if score @s enchantment.adrenaline_boost_INT matches 39 run playsound minecraft:item.armor.equip_iron master @s ~ ~ ~ 20 .9
execute if score @s enchantment.adrenaline_boost_INT matches 59 run playsound minecraft:item.armor.equip_iron master @s ~ ~ ~ 20 1.1
