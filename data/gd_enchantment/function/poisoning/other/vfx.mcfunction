...
execute as @s[scores={enchantment.poisoning_VFX=2}] run playsound minecraft:block.fire.extinguish master @a[distance=..10] ~ ~ ~ 20 1.5
execute as @s[scores={enchantment.poisoning_VFX=6}] run playsound minecraft:entity.player.attack.sweep master @a[distance=..10] ~ ~ ~ 20 .5
execute as @s[scores={enchantment.poisoning_VFX=12}] run playsound minecraft:entity.player.attack.sweep master @a[distance=..10] ~ ~ ~ 20 1
execute as @s[scores={enchantment.poisoning_VFX=8}] run playsound minecraft:block.fire.extinguish master @a[distance=..10] ~ ~ ~ 20 2
