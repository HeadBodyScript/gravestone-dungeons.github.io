...
execute if score @s enchantment.deflect_TD matches 299 run playsound minecraft:block.bell.resonate master @a[distance=..32] ~ ~ ~ 10 2
...
execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:armor_stand,tag=projectile.star_shard1,distance=..4]
...
# execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:armor_stand,tag=projectile.evoker_fangs,distance=..4]
# execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:armor_stand,tag=projectile.light_wave,distance=..4]
# execute if score @s enchantment.deflect_TD matches 1.. run kill @e[type=minecraft:armor_stand,tag=projectile.lightning_strike,distance=..4]
