...
execute if score @s enchantment.mistbreaker_TD matches 5.. run particle minecraft:portal ~ ~1 ~ 2 1 2 1 1
execute if score @s enchantment.mistbreaker_TD matches 30.. run particle minecraft:portal ~ ~1 ~ 2 1 2 1 1
execute if score @s enchantment.mistbreaker_TD matches 55.. run particle minecraft:portal ~ ~1 ~ 2 1 2 1 1

execute unless items entity @s armor.chest #gd_main:modify[minecraft:custom_data={modified:1b,enchantment:1b}] unless items entity @s armor.chest #gd_main:modify[minecraft:custom_data={modified:1b,artifact_3:1b}] run item modify entity @s armor.chest gd_enchantment:mistbreaker
