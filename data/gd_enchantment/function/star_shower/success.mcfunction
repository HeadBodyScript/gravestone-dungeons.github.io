summon armor_stand ~ ~6 ~ {DisabledSlots:4144959,Tags:["rotate_clockwise","marker.star_shower","star_shower"],NoGravity:1b,Small:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"glowstone"}]}
