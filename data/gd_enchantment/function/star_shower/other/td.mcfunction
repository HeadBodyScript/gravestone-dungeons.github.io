...
execute if score @s enchantment.star_shower_TD matches 100 at @s run summon armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,Small:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,Tags:["projectile.star_shower","star_shower"],ArmorItems:[{},{},{},{id:"magma_block"}]}
execute if score @s enchantment.star_shower_TD matches 200 at @s run summon armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,Small:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,Tags:["projectile.star_shower","star_shower"],ArmorItems:[{},{},{},{id:"magma_block"}]}
execute if score @s enchantment.star_shower_TD matches 300 at @s run summon armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,Small:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,Tags:["projectile.star_shower","star_shower"],ArmorItems:[{},{},{},{id:"magma_block"}]}
execute if score @s enchantment.star_shower_TD matches 400 at @s run summon armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,Small:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,Tags:["projectile.star_shower","star_shower"],ArmorItems:[{},{},{},{id:"magma_block"}]}
execute if score @s enchantment.star_shower_TD matches 500 at @s run summon armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,Small:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,Tags:["projectile.star_shower","star_shower"],ArmorItems:[{},{},{},{id:"magma_block"}]}
execute if score @s enchantment.star_shower_TD matches 600 at @s run summon armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,Small:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,Tags:["projectile.star_shower","star_shower"],ArmorItems:[{},{},{},{id:"magma_block"}]}
execute if score @s enchantment.star_shower_TD matches 700 at @s run summon armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,Small:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,Tags:["projectile.star_shower","star_shower"],ArmorItems:[{},{},{},{id:"magma_block"}]}
execute if score @s enchantment.star_shower_TD matches 800 at @s run summon armor_stand ~ ~ ~ {Invisible:1b,Marker:1b,Small:1b,Invulnerable:1b,NoGravity:1b,PersistenceRequired:1b,Tags:["projectile.star_shower","star_shower"],ArmorItems:[{},{},{},{id:"magma_block"}]}
