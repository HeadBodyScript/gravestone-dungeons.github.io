...
execute if score @s enchantment.freezing_VFX matches 210 at @s run kill @e[type=minecraft:armor_stand,tag=marker_freezing,limit=1,sort=nearest]
execute if score @s enchantment.freezing_VFX matches 210 at @s run kill @e[type=minecraft:item_display,tag=marker_freezing,limit=2,sort=nearest]
execute as @s[type=player,scores={enchantment.freezing_VFX=210}] run damage @s 8
execute as @s[type=!player,scores={enchantment.freezing_VFX=210}] run damage @s 20
