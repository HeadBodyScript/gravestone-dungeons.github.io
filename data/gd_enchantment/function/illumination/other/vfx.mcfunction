...
execute as @s[scores={enchantment.illumination_VFX=2}] run playsound minecraft:block.conduit.deactivate master @a[distance=..20] ~ ~ ~ 10 2
execute as @s[scores={enchantment.illumination_VFX=2}] run playsound block.beacon.power_select master @a[distance=..20] ~ ~ ~ 20 2 1
