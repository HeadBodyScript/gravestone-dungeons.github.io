...
execute as @s[scores={enchantment.bleeding_VFX=6..7}] run function gd_enchantment:enchantment/bleeding/other/init
execute as @s[scores={enchantment.bleeding_VFX=15..16}] run function gd_enchantment:enchantment/bleeding/other/init
