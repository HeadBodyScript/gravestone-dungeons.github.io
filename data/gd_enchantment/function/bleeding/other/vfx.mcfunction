...
execute as @s[scores={enchantment.bleeding_VFX=2}] run playsound minecraft:entity.player.hurt_freeze master @a[distance=..10] ~ ~ ~ 20 1
execute as @s[scores={enchantment.bleeding_VFX=2}] run playsound minecraft:entity.player.attack.knockback master @a[distance=..10] ~ ~ ~ 20 .5
execute as @s[scores={enchantment.bleeding_VFX=8}] run playsound minecraft:entity.player.attack.sweep master @a[distance=..10] ~ ~ ~ 20 .5
execute as @s[scores={enchantment.bleeding_VFX=12}] run playsound minecraft:entity.player.attack.sweep master @a[distance=..10] ~ ~ ~ 20 1
execute as @s[scores={enchantment.bleeding_VFX=12}] run playsound minecraft:entity.player.hurt_freeze master @a[distance=..10] ~ ~ ~ 20 .5
execute as @s[scores={enchantment.bleeding_VFX=19}] run playsound minecraft:entity.player.attack.sweep master @a[distance=..10] ~ ~ ~ 20 2
