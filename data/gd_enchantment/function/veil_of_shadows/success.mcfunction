...
playsound minecraft:entity.breeze.idle_ground master @a[distance=..10] ~ ~ ~ 1 1
playsound minecraft:entity.breeze.inhale master @a[distance=..10] ~ ~ ~ 1 1

playsound minecraft:block.wool.step master @a[distance=..10] ~ ~ ~ 1 0.1