...
execute as @p if predicate gd_main:is_sneaking if score @s mana matches 200.. run scoreboard players add @s tick 2
...
execute if score @p tick matches 2.. run scoreboard players remove @p mana 200
